...
$App.teslaspc = localStorage.getItem("teslapc");
...
$scope.Ellipse1_click = function() {if ($App.pass == "63") {
$App.donotpress = "red";
localStorage.setItem("donotpress",$App.donotpress);
$scope.SetObjectStyle("Ellipse1","fill",$App.donotpress);
localStorage.setItem("donotpress",$App.donotpress);
$scope.GotoPage( "Reset" );
} else {
$App.donotpress = "green";
localStorage.setItem("donotpress",$App.donotpress);
$scope.SetObjectStyle("Ellipse1","fill",$App.donotpress);
localStorage.setItem("donotpress",$App.donotpress);
};};
...
NeoApp.controller("NeedsAttention_Ctrl", function($scope,$rootScope,$route,$timeout,$filter,$window,$animate) {
$App.NAB.PageNumber = 15;
$App.NAB.PageID = "NeedsAttention";
$scope.TextArea91_change = function() {localStorage.setItem("na1",$App.na1);};
$scope.PushButton288_click = function() {$scope.GotoPage( "Home" );};
$scope.PushButton290_click = function() {$scope.GotoPage( "Home" );};
$scope.PushButton302_click = function() {neoTalkSpeak($App.Prayer1main, "uk", 1, .9);};
$scope.PushButton303_click = function() {neoTalkCancelSpeech();};
$scope.TextArea127_change = function() {localStorage.setItem("na2",$App.na2);};
$scope.TextArea128_change = function() {localStorage.setItem("na4",$App.na4);};
$scope.TextArea129_change = function() {localStorage.setItem("na3",$App.na3);};
$scope.Container30_click = function() {$App.donotpress = "white";
localStorage.setItem("donotpress",$App.white);};
});
...
$scope.Image51_click = function() {$scope.GotoPage( "Dream" );};
});
...
$scope.Slider2_change = function() {localStorage.setItem("teslapc",$App.teslaspc);};
